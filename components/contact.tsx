    ...
    <section id="contact" className="py-20 bg-gray-50 dark:bg-gray-900">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div>
            <Card className="border-0 shadow-md h-full dark:bg-gray-800 dark:border-gray-700">
              <CardContent className="p-8">
                ...
                <div className="mt-8">
                  ...
                  <div className="flex space-x-4">
                    <a
                      href="#"
                      className="bg-gray-200 hover:bg-purple-100 p-2 rounded-full transition-colors dark:bg-gray-700 dark:hover:bg-gray-600"
                    >
                      <svg
