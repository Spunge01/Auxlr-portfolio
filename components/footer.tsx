    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Auxlr</h3>
          ...
          <div>
            ...
            <form className="flex">
              <input
                ...
                className="px-4 py-2 w-full rounded-l-md focus:outline-none focus:ring-2 focus:ring-purple-600 bg-gray-800 text-white"
              />
              <button
                type="submit"
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">&copy; {currentYear} Auxlr. All rights reserved.</p>
